...
from crypto_quant_loop.research.carry import (
    ...
    save_refined_carry_feasibility_report,
)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=float,
        action="append",
        dest="margin_cost_aprs",
        help="Opportunity-cost APR sensitivity value; can be repeated.",
    )
    parser.add_argument(
        "--principal",
        type=float,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    margin_cost_aprs = tuple(args.margin_cost_aprs or [0.0, 0.03, 0.05])
    ...
    save_refined_carry_feasibility_report(report, Path(args.report_path))
    return 0
