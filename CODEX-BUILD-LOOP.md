...
- 产物：刻画资金费率 regime（正费率占比、量级、持续性）；估算历史**毛 carry**，再扣手续费、两腿滑点、保证金成本，得**净 carry**；做不同本金规模的盈亏平衡分析。
- DoD：一份报告明确回答"扣全部成本后净 carry 是否为正、在什么本金量级才有意义"。**若为负或仅在远超 1000 USDT 时为正，如实上报并暂停 F3，等人工决定。**
